...
# ===================== 私有数据加载函数 =====================
def load_2006_2020_data(project_root: Path) -> Optional[pd.DataFrame]:
    """
    加载2006-2020年数据（私有函数）
    """
...
# ===================== 双公式回测 =====================
def fzt_zsqsx_2006_2020_backtest():
    """FZT + ZSQSX 双公式回测 (2006-2020年)"""
    try:
        print("=" * 80)
        print("🚀 FZT + ZSQSX 双公式回测 (2006-2020年)")
        print("=" * 80)
        ...
        # 8. 保存结果
        print("\n💾 保存结果...")
        results_dir = project_root / 'results' / 'fzt_zsqsx_2006_2020'
        ...
        with open(report_path, 'w', encoding='utf-8') as f:
            f.write("=" * 60 + "\n")
            f.write("FZT + ZSQSX 双公式回测报告 (2006-2020年)\n")
            f.write("=" * 60 + "\n\n")
            f.write(f"回测时间范围: 2006-01-01 到 2020-09-25\n")
...
if __name__ == "__main__":
    # 运行回测
    exit_code = fzt_zsqsx_2006_2020_backtest()
    sys.exit(exit_code)